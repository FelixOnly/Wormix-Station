...
ent-RandomHumanoidVisitorWarden = посетитель смотритель роль призрака
    .desc = { "" }
ent-RandomHumanoidVisitorCargoTechnician = посетитель карго техник роль призрака
    .desc = { "" }
...
ent-RandomHumanoidChallengeVictimQM = жертва катастрофы КМ роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
ent-RandomHumanoidChallengeCargoTechnician = жертва катастрофы карго техник роль призрака
    .suffix = ЧЕЛЛЕНДЖ
    .desc = { ent-RandomHumanoidChallengeVictimCaptain.desc }
