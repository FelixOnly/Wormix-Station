...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<int> NsfwPreferencesLength =
        CVarDef.Create("ic.nsfw_preferences_length", 13500, CVar.SERVER | CVar.REPLICATED);
}
